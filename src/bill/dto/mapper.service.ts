...
import { SendNoteDto } from "./sendNote.dto";
import { SynInvoiceLegendDto } from "src/model/dto/synInvoiceLegend.dto";


@Injectable()
export class MapperService {
    constructor(private synProductServiceService:SynProductServiceService, private synInvoiceLegendService:SynInvoiceLegendService,  private parameterService:ParameterService) {}
    ...
    async mapSendNoteDtoToEbBillDto(sendNoteDto: SendNoteDto, ebBillDtoOriginal:EbBillDto, ebSystemDto:EbSystemDto):Promise<EbBillDto> {
        ...
        ebBillDto.details = ebBillDtoOriginal.details.map( item => {
