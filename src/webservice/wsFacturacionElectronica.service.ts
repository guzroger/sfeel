...
@Injectable()
export class WsFacturacionElectronicaService implements WsFacturacionService{
    constructor(
    ...
    recepcionAnexosSuministroEnergia(ebBillDto:EbBillDto, ebSystemDto: EbSystemDto, cuis:string, xmlBill:string, hash:string, urlService:string){
        let dateEmiite = ebBillDto.dateEmitte.toISOString();
          ...
          const xml = `<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:siat="https://siat.impuestos.gob.bo/">
                        <soapenv:Header/>
                        <soapenv:Body>
                          <siat:recepcionAnexosSuministroEnergia>
                              <SolicitudRecepcionSuministroAnexos>
                                ...
                                ${ebBillDto.details.map((item) => {
                                    return `<anexosList>
                                                <cufFactSuministro>?</cufFactSuministro>
                                                <fechaRecarga>?</fechaRecarga>
                                                <montoRecarga>?</montoRecarga>
                                            </anexosList>`;}).join(`
                                              `)}   
                                <giftCard>${ebBillDto.amountGiftCard}</giftCard>
                              </SolicitudRecepcionSuministroAnexos>
                          </siat:recepcionAnexosSuministroEnergia>
                        </soapenv:Body>
                    </soapenv:Envelope>`;
