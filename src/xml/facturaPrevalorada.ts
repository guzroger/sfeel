...
export class FacturaPrevalorada {
  static facturaElectronicaPrevalorada(
    data: EbBillDto,
    ...
    <facturaElectronicaPrevalorada xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                                   xsi:noNamespaceSchemaLocation="facturaElectronicaPrevalorada.xsd">
        <cabecera>
  ...
  static facturaComputarizadaPrevalorada(
    data: EbBillDto,
    ebSucursalDto: EbSucursalDto
  ): string {
    let dateEmiite = data.dateEmitte.toISOString();
    ...
    const xml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
    <facturaComputarizadaPrevalorada xsi:noNamespaceSchemaLocation="facturaComputarizadaPrevalorada.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
        <cabecera>
            <nitEmisor>${data.nitEmitter}</nitEmisor>
            <razonSocialEmisor>${data.billNameEmitter}</razonSocialEmisor>
            <municipio>${ebSucursalDto.municipality}</municipio>
