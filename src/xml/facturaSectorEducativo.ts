...
export class FacturaSectorEducativo {
    ...
    const xml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
                <facturaElectronicaSectorEducativo xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                                            xsi:noNamespaceSchemaLocation="facturaElectronicaSectorEducativo.xsd">
                    <cabecera>
                        ...
                        <nombreEstudiante>${ebBillDto.studentName}</nombreEstudiante>
                        <periodoFacturado>${ebBillDto.billedPeriod}</periodoFacturado>
                        <codigoMetodoPago>${
