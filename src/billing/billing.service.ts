...
import { SignerXmlService } from '../common/signerXml.service';
...
import { CreateEventDto } from '../bill/dto/createEvent.dto';
  ...
  async sendBill( ebBillDto: EbBillDto, ebSystemDto: EbSystemDto,): Promise<SendBillResponseDto> {
    ...
    try{  
      ...
      if(ebBillDto.emitteType == Constants.EmitterTypeMassive)
      {
        ...
        return this.sendBillOffLine( ebBillDto, ebSystemDto, ebCufdDto, ebCuisDto, Constants.EmitterTypeMassive);
      }
