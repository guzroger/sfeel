...
export class NotaDebitoCreditoDescuento {
    ...
    static notaDebitoCreditoElectronica(ebBillDto: EbBillDto, ebSucursalDto:EbSucursalDto):string{
        ...
        <notaElectronicaCreditoDebitoDescuento xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                                            xsi:noNamespaceSchemaLocation="notaElectronicaCreditoDebitoDescuento.xsd">
            <cabecera>
                ...
                <descuentoAdicional>${ebBillDto.amountDiscount.toFixed(2)}</descuentoAdicional>
                <montoTotalDevuelto>${ Math.round((ebBillDto.amountTotalReturned + Number.EPSILON) * 100) / 100  }</montoTotalDevuelto>                
                ${
              ...
              ${ebBillDto.details.map((item) => {
                return `<detalle>
                            <nroItem>${item.numberItem}</nroItem>
    ...
    static notaDebitoCreditoComputarizada(ebBillDto: EbBillDto, ebSucursalDto:EbSucursalDto):string{
        ...
        const xml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
        <notaComputarizadaCreditoDebitoDescuento xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
