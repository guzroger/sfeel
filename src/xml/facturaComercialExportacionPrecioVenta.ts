import { EbExportCommercialSalesPrice } from "src/model/dto/ebExportCommercialSalesPrice.dto";
import { EbSucursalDto } from "../model/dto/ebSucursal.dto";
export class FacturaComercialExportaciónPrecioVenta {
  static facturaElectronicaComercialExportaciónPrecioVenta(
    data: EbExportCommercialSalesPrice,
    ...
    <facturaElectronicaComercialExportacionPVenta xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        ...
        <cabecera>
            ...
            <precioValorBruto>${data.priceGrossValue}</precioValorBruto>
        ...
        ${data.details.map((item) => {
          return `<detalle>
                        ...
                        <codigoProductoSin>${item.codeNandina}</codigoProductoSin>
  ...
  static facturaComputarizadaComercialExportaciónPrecioVenta(
    data: EbExportCommercialSalesPrice,
    ebSucursalDto: EbSucursalDto
  ): string {
    let dateEmiite = data.dateEmiite.toISOString();
    ...
    const xml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
    <facturaComputarizadaComercialExportacionPVenta xsi:noNamespaceSchemaLocation="facturaComputarizadaComercialExportacionPVenta.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <cabecera>
            <nitEmisor>${data.nitEmitter}</nitEmisor>
            <razonSocialEmisor>${data.billNameEmitter}</razonSocialEmisor>
            <municipio>${ebSucursalDto.municipality}</municipio>
        ...
        ${data.details.map((item) => {
          return `<detalle>
                    ...
                    `)}  
    </facturaComputarizadaComercialExportacionPVenta>
    `;
    return xml;
  }
}
